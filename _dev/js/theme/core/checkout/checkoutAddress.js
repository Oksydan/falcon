 ...
 * @param {String} type
 */
const switchEditAddressButtonColor = function(
    enabled,
    id,
    type,
) {
 ...
 */
const switchConfirmAddressesButtonState = function(enable) {
...
const handleOnLoad = () => {
    ...
    const getVisibleAddressErrors = () => {
        return Array.from(getAllAddressErrors()).filter(isElementVisible);
    }
